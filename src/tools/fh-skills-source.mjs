...
const POIDS_DES_JEUX = "eric:2026-09-23 — un jeu de table se porte, donc il pèse. " +
  ...
  "Fate's Hand, du même genre que les poids des 54 gemmes.";

/* ⚖️ LE PRIX — ERIC, 2026-09-23 : « prends le prix SRD s'il existe, prends le
   prix Pathfinder sinon ». Appliqué dans cet ordre, il ne donne le SRD à
   AUCUN de ces outils : `srd:tool:en:gaming-set` et `srd:tool:en:musical-instrument`
   portent tous deux « Varies », et le SRD n'a ni véhicule ni monture.
   ⭐ La règle s'arrête donc au second cran pour les cinq outils qui sont des
   OBJETS, et n'a rien à saisir pour les sept autres.
   ⛔ ET LE PRIX EST, LUI AUSSI, UN NOMBRE D'ERIC : §0.8 refuse l'OGL comme
   elle refuse le PHB. La référence a servi à CHOISIR, pas à FOURNIR. */
const PRIX_DES_JEUX = "eric:2026-09-23 — « prends le prix SRD s'il existe, prends le prix " +
  "Pathfinder sinon ». Le SRD n'en donne aucun (`gaming-set` = « Varies »). La référence " +
  "ouverte chiffre une FOURCHETTE (1 sp–100 gp pour les cartes, 1 sp–10 gp pour un jeu à " +

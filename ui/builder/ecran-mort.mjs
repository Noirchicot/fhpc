...
import { currentStack } from "./universe-step.mjs?v=816";
...
import { compositionFh } from "./layers-ecran.mjs?v=816";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=816";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=816";

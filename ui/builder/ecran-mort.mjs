...
import { currentStack } from "./universe-step.mjs?v=800";
...
import { compositionFh } from "./layers-ecran.mjs?v=800";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=800";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=800";

...
import { currentStack } from "./universe-step.mjs?v=774";
...
import { compositionFh } from "./layers-ecran.mjs?v=774";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=774";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=774";

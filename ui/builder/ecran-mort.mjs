...
import { currentStack } from "./universe-step.mjs?v=626";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=626";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=626";

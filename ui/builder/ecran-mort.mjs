...
import { currentStack } from "./universe-step.mjs?v=780";
...
import { compositionFh } from "./layers-ecran.mjs?v=780";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=780";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=780";

...
import { currentStack } from "./universe-step.mjs?v=743";
...
import { compositionFh } from "./layers-ecran.mjs?v=743";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=743";

...
import { currentStack } from "./universe-step.mjs?v=787";
...
import { compositionFh } from "./layers-ecran.mjs?v=787";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=787";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=787";

...
import { currentStack } from "./universe-step.mjs?v=812";
...
import { compositionFh } from "./layers-ecran.mjs?v=812";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=812";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=812";

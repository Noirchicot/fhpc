...
import { currentStack } from "./universe-step.mjs?v=821";
...
import { compositionFh } from "./layers-ecran.mjs?v=821";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=821";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=821";

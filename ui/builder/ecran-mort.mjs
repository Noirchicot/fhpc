...
import { currentStack } from "./universe-step.mjs?v=620";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=620";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=620";

...
import { currentStack } from "./universe-step.mjs?v=654";
...
import { compositionFh } from "./layers-ecran.mjs?v=654";
...
import { motHumainDeLId, MOT_HORS_PILE } from "./mot-du-choix.mjs?v=654";
import { interrupteurDUnId } from "./interrupteurs.mjs?v=654";

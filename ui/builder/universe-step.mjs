...
import { motDeLEchelon } from "./echelle.mjs?v=794";
...
import { interrupteur, voyant, ligneReservee, renderLayersEcran, compositionFh } from "./layers-ecran.mjs?v=794";
...
import { renderMagasinEcran } from "./magasin-ecran.mjs?v=794";

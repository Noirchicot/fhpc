...
import { motDeLEchelon } from "./echelle.mjs?v=727";
...
import { interrupteur, voyant, ligneReservee, renderLayersEcran, compositionFh } from "./layers-ecran.mjs?v=727";
...
import { renderMagasinEcran } from "./magasin-ecran.mjs?v=727";

...
import { motDeLEchelon } from "./echelle.mjs?v=832";
...
import { interrupteur, voyant, ligneReservee, renderLayersEcran, compositionFh } from "./layers-ecran.mjs?v=832";
...
import { renderMagasinEcran } from "./magasin-ecran.mjs?v=832";

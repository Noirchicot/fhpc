...
export const ORGANES = [
  ...
  { nom: "FILET HAUT",    sorte: "zone",          x:   77.5, y:     78, l:   220, h:   12, mot: "", cran: "T1/600" },
  { nom: "DESCRIPTION",   sorte: "zone",          x:     30, y:     90, l:   315, h:  164, mot: "Description", cran: "T2/400" },
  { nom: "FILET BAS",     sorte: "zone",          x:   77.5, y:    254, l:   220, h:   12, mot: "", cran: "T1/600" },

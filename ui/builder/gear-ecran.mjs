...
import * as D from "./gear-disposition.mjs?v=688";
import { BOITES } from "./b3-disposition.mjs?v=688";
import { armerJeton, fantome } from "./glisser.mjs?v=688";
/* ⭐ LE JETON EST UN ORGANE, PAS UN DESSIN DE CET ÉCRAN — `jeton-objet.mjs`, module
   feuille sans import, que le sac porte aussi. */
import { corpsDuJeton, motDuJeton } from "./jeton-objet.mjs?v=688";
import { versionQuery } from "./version.mjs?v=688";
import { enGP } from "./equipement-pipeline.mjs?v=688";

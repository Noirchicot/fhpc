...
import * as D from "./gear-disposition.mjs?v=848";
import { BOITES, CASES_DU_BODY_FORGING } from "./b3-disposition.mjs?v=848";
...
import { enGP } from "./equipement-pipeline.mjs?v=848";

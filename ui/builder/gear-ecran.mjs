...
import * as D from "./gear-disposition.mjs?v=634";
import { BOITES } from "./b3-disposition.mjs?v=634";
import { armerJeton, fantome } from "./glisser.mjs?v=634";
import { versionQuery } from "./version.mjs?v=634";
import { enGP } from "./equipement-pipeline.mjs?v=634";

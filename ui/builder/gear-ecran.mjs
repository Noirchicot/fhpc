...
import * as D from "./gear-disposition.mjs?v=675";
import { BOITES } from "./b3-disposition.mjs?v=675";
import { armerJeton, fantome } from "./glisser.mjs?v=675";
/* ⭐ LE JETON EST UN ORGANE, PAS UN DESSIN DE CET ÉCRAN — `jeton-objet.mjs`, module
   feuille sans import, que le sac porte aussi. */
import { corpsDuJeton, motDuJeton } from "./jeton-objet.mjs?v=675";
import { versionQuery } from "./version.mjs?v=675";
import { enGP } from "./equipement-pipeline.mjs?v=675";

...
import * as D from "./gear-disposition.mjs?v=650";
import { BOITES } from "./b3-disposition.mjs?v=650";
import { armerJeton, fantome } from "./glisser.mjs?v=650";
import { versionQuery } from "./version.mjs?v=650";
import { enGP } from "./equipement-pipeline.mjs?v=650";

...
import * as D from "./gear-disposition.mjs?v=676";
import { BOITES } from "./b3-disposition.mjs?v=676";
import { armerJeton, fantome } from "./glisser.mjs?v=676";
/* ⭐ LE JETON EST UN ORGANE, PAS UN DESSIN DE CET ÉCRAN — `jeton-objet.mjs`, module
   feuille sans import, que le sac porte aussi. */
import { corpsDuJeton, motDuJeton } from "./jeton-objet.mjs?v=676";
import { versionQuery } from "./version.mjs?v=676";
import { enGP } from "./equipement-pipeline.mjs?v=676";

...
import * as D from "./gear-disposition.mjs?v=651";
import { BOITES } from "./b3-disposition.mjs?v=651";
import { armerJeton, fantome } from "./glisser.mjs?v=651";
import { versionQuery } from "./version.mjs?v=651";
import { enGP } from "./equipement-pipeline.mjs?v=651";

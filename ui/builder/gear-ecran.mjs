...
import * as D from "./gear-disposition.mjs?v=656";
import { BOITES } from "./b3-disposition.mjs?v=656";
import { armerJeton, fantome } from "./glisser.mjs?v=656";
...
import { enGP } from "./equipement-pipeline.mjs?v=656";

...
import * as D from "./gear-disposition.mjs?v=655";
import { BOITES } from "./b3-disposition.mjs?v=655";
import { armerJeton, fantome } from "./glisser.mjs?v=655";
...
import { enGP } from "./equipement-pipeline.mjs?v=655";

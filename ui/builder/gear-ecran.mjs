...
import * as D from "./gear-disposition.mjs?v=767";
import { BOITES } from "./b3-disposition.mjs?v=767";
import { armerJeton, fantome } from "./glisser.mjs?v=767";
...
import { enGP } from "./equipement-pipeline.mjs?v=767";

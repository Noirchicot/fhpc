...
import * as D from "./gear-disposition.mjs?v=648";
import { BOITES } from "./b3-disposition.mjs?v=648";
import { armerJeton, fantome } from "./glisser.mjs?v=648";
import { versionQuery } from "./version.mjs?v=648";
import { enGP } from "./equipement-pipeline.mjs?v=648";

...
import * as D from "./gear-disposition.mjs?v=658";
import { BOITES } from "./b3-disposition.mjs?v=658";
import { armerJeton, fantome } from "./glisser.mjs?v=658";
...
import { enGP } from "./equipement-pipeline.mjs?v=658";

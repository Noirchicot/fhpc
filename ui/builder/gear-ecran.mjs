...
import * as D from "./gear-disposition.mjs?v=643";
import { BOITES } from "./b3-disposition.mjs?v=643";
import { armerJeton, fantome } from "./glisser.mjs?v=643";
import { versionQuery } from "./version.mjs?v=643";
import { enGP } from "./equipement-pipeline.mjs?v=643";

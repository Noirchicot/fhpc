...
import * as D from "./gear-disposition.mjs?v=633";
import { BOITES } from "./b3-disposition.mjs?v=633";
import { armerJeton, fantome } from "./glisser.mjs?v=633";
import { versionQuery } from "./version.mjs?v=633";
import { enGP } from "./equipement-pipeline.mjs?v=633";

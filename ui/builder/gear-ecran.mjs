...
import * as D from "./gear-disposition.mjs?v=649";
import { BOITES } from "./b3-disposition.mjs?v=649";
import { armerJeton, fantome } from "./glisser.mjs?v=649";
import { versionQuery } from "./version.mjs?v=649";
import { enGP } from "./equipement-pipeline.mjs?v=649";

...
import * as D from "./gear-disposition.mjs?v=647";
import { BOITES } from "./b3-disposition.mjs?v=647";
import { armerJeton, fantome } from "./glisser.mjs?v=647";
import { versionQuery } from "./version.mjs?v=647";
import { enGP } from "./equipement-pipeline.mjs?v=647";

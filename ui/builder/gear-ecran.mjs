...
import * as D from "./gear-disposition.mjs?v=657";
import { BOITES } from "./b3-disposition.mjs?v=657";
import { armerJeton, fantome } from "./glisser.mjs?v=657";
...
import { enGP } from "./equipement-pipeline.mjs?v=657";

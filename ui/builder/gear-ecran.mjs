...
import * as D from "./gear-disposition.mjs?v=644";
import { BOITES } from "./b3-disposition.mjs?v=644";
import { armerJeton, fantome } from "./glisser.mjs?v=644";
import { versionQuery } from "./version.mjs?v=644";
import { enGP } from "./equipement-pipeline.mjs?v=644";

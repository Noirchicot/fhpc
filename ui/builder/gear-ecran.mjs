...
import * as D from "./gear-disposition.mjs?v=637";
import { BOITES } from "./b3-disposition.mjs?v=637";
import { armerJeton, fantome } from "./glisser.mjs?v=637";
import { versionQuery } from "./version.mjs?v=637";
import { enGP } from "./equipement-pipeline.mjs?v=637";

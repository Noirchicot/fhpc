...
import * as D from "./gear-disposition.mjs?v=847";
import { BOITES, CASES_DU_BODY_FORGING } from "./b3-disposition.mjs?v=847";
...
import { enGP } from "./equipement-pipeline.mjs?v=847";

...
import * as D from "./gear-disposition.mjs?v=636";
import { BOITES } from "./b3-disposition.mjs?v=636";
import { armerJeton, fantome } from "./glisser.mjs?v=636";
import { versionQuery } from "./version.mjs?v=636";
import { enGP } from "./equipement-pipeline.mjs?v=636";

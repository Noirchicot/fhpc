...
import * as D from "./gear-disposition.mjs?v=635";
import { BOITES } from "./b3-disposition.mjs?v=635";
import { armerJeton, fantome } from "./glisser.mjs?v=635";
import { versionQuery } from "./version.mjs?v=635";
import { enGP } from "./equipement-pipeline.mjs?v=635";

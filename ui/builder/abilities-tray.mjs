...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=248";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=248";
import { swapContent } from "./socle.mjs?v=248";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=49";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=49";
import { swapContent } from "./socle.mjs?v=49";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=275";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=275";
import { swapContent } from "./socle.mjs?v=275";

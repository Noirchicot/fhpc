...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=164";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=164";
import { swapContent } from "./socle.mjs?v=164";

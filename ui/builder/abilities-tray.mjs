...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=62";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=62";
import { swapContent } from "./socle.mjs?v=62";

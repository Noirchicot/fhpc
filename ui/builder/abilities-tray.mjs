...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=267";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=267";
import { swapContent } from "./socle.mjs?v=267";

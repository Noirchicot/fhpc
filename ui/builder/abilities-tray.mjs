...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=69";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=69";
import { swapContent } from "./socle.mjs?v=69";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=171";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=171";
import { swapContent } from "./socle.mjs?v=171";

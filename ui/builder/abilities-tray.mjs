...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=179";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=179";
import { swapContent } from "./socle.mjs?v=179";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=210";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=210";
import { swapContent } from "./socle.mjs?v=210";

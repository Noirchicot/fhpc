...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=220";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=220";
import { swapContent } from "./socle.mjs?v=220";

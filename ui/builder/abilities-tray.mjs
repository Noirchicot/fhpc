...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=97";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=97";
import { swapContent } from "./socle.mjs?v=97";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=112";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=112";
import { swapContent } from "./socle.mjs?v=112";

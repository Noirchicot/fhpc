...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=96";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=96";
import { swapContent } from "./socle.mjs?v=96";

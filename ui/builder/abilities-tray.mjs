...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=70";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=70";
import { swapContent } from "./socle.mjs?v=70";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=249";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=249";
import { swapContent } from "./socle.mjs?v=249";

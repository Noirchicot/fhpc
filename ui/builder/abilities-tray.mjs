...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=194";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=194";
import { swapContent } from "./socle.mjs?v=194";

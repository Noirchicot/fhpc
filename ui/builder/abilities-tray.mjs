...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=241";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=241";
import { swapContent } from "./socle.mjs?v=241";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=195";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=195";
import { swapContent } from "./socle.mjs?v=195";

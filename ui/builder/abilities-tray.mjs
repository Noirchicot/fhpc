...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=204";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=204";
import { swapContent } from "./socle.mjs?v=204";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=64";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=64";
import { swapContent } from "./socle.mjs?v=64";

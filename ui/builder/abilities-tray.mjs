...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=83";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=83";
import { swapContent } from "./socle.mjs?v=83";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=20";
import { rollThreeD6, markKept, rollAbilitySet } from "./dice.mjs?v=20";
import { swapContent } from "./socle.mjs?v=20";

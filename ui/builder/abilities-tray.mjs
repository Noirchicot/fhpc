...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=268";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=268";
import { swapContent } from "./socle.mjs?v=268";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=243";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=243";
import { swapContent } from "./socle.mjs?v=243";

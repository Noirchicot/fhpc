...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=255";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=255";
import { swapContent } from "./socle.mjs?v=255";

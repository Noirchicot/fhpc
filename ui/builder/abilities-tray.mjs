...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=160";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=160";
import { swapContent } from "./socle.mjs?v=160";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=265";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=265";
import { swapContent } from "./socle.mjs?v=265";

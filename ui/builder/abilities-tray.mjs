...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=222";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=222";
import { swapContent } from "./socle.mjs?v=222";

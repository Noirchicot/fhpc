...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=79";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=79";
import { swapContent } from "./socle.mjs?v=79";

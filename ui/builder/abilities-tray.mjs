...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=65";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=65";
import { swapContent } from "./socle.mjs?v=65";

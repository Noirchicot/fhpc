...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=147";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=147";
import { swapContent } from "./socle.mjs?v=147";

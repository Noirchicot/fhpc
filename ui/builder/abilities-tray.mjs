...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=114";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=114";
import { swapContent } from "./socle.mjs?v=114";

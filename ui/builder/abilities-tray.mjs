...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=193";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=193";
import { swapContent } from "./socle.mjs?v=193";

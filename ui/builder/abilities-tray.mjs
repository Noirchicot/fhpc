...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=51";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=51";
import { swapContent } from "./socle.mjs?v=51";

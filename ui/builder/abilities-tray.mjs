...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=191";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=191";
import { swapContent } from "./socle.mjs?v=191";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=123";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=123";
import { swapContent } from "./socle.mjs?v=123";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=94";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=94";
import { swapContent } from "./socle.mjs?v=94";

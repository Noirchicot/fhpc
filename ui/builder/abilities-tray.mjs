...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=121";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=121";
import { swapContent } from "./socle.mjs?v=121";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=276";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=276";
import { swapContent } from "./socle.mjs?v=276";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=253";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=253";
import { swapContent } from "./socle.mjs?v=253";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=131";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=131";
import { swapContent } from "./socle.mjs?v=131";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=154";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=154";
import { swapContent } from "./socle.mjs?v=154";

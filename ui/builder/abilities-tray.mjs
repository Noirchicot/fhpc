...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=95";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=95";
import { swapContent } from "./socle.mjs?v=95";

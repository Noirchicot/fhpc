...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=240";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=240";
import { swapContent } from "./socle.mjs?v=240";

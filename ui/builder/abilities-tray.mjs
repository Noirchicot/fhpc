...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=105";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=105";
import { swapContent } from "./socle.mjs?v=105";

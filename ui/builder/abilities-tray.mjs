...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=47";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=47";
import { swapContent } from "./socle.mjs?v=47";

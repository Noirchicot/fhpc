...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=227";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=227";
import { swapContent } from "./socle.mjs?v=227";

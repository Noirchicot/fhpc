...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=66";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=66";
import { swapContent } from "./socle.mjs?v=66";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=88";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=88";
import { swapContent } from "./socle.mjs?v=88";

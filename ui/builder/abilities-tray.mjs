...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=74";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=74";
import { swapContent } from "./socle.mjs?v=74";

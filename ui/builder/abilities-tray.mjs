...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=73";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=73";
import { swapContent } from "./socle.mjs?v=73";

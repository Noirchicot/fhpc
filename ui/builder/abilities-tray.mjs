...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=53";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=53";
import { swapContent } from "./socle.mjs?v=53";

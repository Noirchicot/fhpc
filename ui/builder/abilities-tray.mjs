...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=98";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=98";
import { swapContent } from "./socle.mjs?v=98";

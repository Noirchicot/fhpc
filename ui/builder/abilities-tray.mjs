...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=91";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=91";
import { swapContent } from "./socle.mjs?v=91";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=89";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=89";
import { swapContent } from "./socle.mjs?v=89";

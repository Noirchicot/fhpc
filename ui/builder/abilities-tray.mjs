...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=101";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=101";
import { swapContent } from "./socle.mjs?v=101";

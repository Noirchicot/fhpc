...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=218";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=218";
import { swapContent } from "./socle.mjs?v=218";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=129";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=129";
import { swapContent } from "./socle.mjs?v=129";

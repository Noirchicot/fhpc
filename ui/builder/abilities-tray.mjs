...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=219";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=219";
import { swapContent } from "./socle.mjs?v=219";

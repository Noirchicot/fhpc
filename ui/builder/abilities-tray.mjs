...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=145";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=145";
import { swapContent } from "./socle.mjs?v=145";

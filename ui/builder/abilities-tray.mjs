...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=156";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=156";
import { swapContent } from "./socle.mjs?v=156";

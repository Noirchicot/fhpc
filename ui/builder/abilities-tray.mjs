...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=200";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=200";
import { swapContent } from "./socle.mjs?v=200";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=169";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=169";
import { swapContent } from "./socle.mjs?v=169";

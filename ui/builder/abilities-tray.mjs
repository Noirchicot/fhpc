...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=233";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=233";
import { swapContent } from "./socle.mjs?v=233";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=76";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=76";
import { swapContent } from "./socle.mjs?v=76";

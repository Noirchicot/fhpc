...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=45";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=45";
import { swapContent } from "./socle.mjs?v=45";

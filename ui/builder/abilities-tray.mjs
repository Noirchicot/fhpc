...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=16";
import { rollThreeD6, markKept, rollAbilitySet } from "./dice.mjs?v=16";
import { swapContent } from "./socle.mjs?v=16";

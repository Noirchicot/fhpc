...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=108";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=108";
import { swapContent } from "./socle.mjs?v=108";

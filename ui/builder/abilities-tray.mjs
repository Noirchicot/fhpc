...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=274";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=274";
import { swapContent } from "./socle.mjs?v=274";

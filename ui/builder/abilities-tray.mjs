...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=264";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=264";
import { swapContent } from "./socle.mjs?v=264";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=52";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=52";
import { swapContent } from "./socle.mjs?v=52";

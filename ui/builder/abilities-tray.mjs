...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=189";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=189";
import { swapContent } from "./socle.mjs?v=189";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=254";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=254";
import { swapContent } from "./socle.mjs?v=254";

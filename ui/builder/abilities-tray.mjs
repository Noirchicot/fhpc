...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=71";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=71";
import { swapContent } from "./socle.mjs?v=71";

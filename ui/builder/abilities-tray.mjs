...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=140";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=140";
import { swapContent } from "./socle.mjs?v=140";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=272";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=272";
import { swapContent } from "./socle.mjs?v=272";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=80";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=80";
import { swapContent } from "./socle.mjs?v=80";

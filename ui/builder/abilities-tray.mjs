...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=132";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=132";
import { swapContent } from "./socle.mjs?v=132";

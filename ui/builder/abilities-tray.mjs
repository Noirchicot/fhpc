...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=205";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=205";
import { swapContent } from "./socle.mjs?v=205";

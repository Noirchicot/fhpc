...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=237";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=237";
import { swapContent } from "./socle.mjs?v=237";

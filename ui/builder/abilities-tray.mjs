...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=271";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=271";
import { swapContent } from "./socle.mjs?v=271";

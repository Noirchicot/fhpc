...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=151";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=151";
import { swapContent } from "./socle.mjs?v=151";

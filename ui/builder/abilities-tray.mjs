...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=81";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=81";
import { swapContent } from "./socle.mjs?v=81";

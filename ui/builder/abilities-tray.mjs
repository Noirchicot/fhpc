...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=207";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=207";
import { swapContent } from "./socle.mjs?v=207";

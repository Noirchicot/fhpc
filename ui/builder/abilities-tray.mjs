...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=185";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=185";
import { swapContent } from "./socle.mjs?v=185";

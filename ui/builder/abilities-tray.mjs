...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=277";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=277";
import { swapContent } from "./socle.mjs?v=277";

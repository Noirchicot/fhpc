...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=75";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=75";
import { swapContent } from "./socle.mjs?v=75";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=209";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=209";
import { swapContent } from "./socle.mjs?v=209";

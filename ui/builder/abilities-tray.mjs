...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=60";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=60";
import { swapContent } from "./socle.mjs?v=60";

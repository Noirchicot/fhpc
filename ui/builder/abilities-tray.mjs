...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=82";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=82";
import { swapContent } from "./socle.mjs?v=82";

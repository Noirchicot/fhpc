...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=152";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=152";
import { swapContent } from "./socle.mjs?v=152";

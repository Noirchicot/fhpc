...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=58";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=58";
import { swapContent } from "./socle.mjs?v=58";

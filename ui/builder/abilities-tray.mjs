...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=228";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=228";
import { swapContent } from "./socle.mjs?v=228";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=78";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=78";
import { swapContent } from "./socle.mjs?v=78";

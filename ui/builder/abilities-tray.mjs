...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=263";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=263";
import { swapContent } from "./socle.mjs?v=263";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=266";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=266";
import { swapContent } from "./socle.mjs?v=266";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=56";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=56";
import { swapContent } from "./socle.mjs?v=56";

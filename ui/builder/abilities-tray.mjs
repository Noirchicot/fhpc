...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=184";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=184";
import { swapContent } from "./socle.mjs?v=184";

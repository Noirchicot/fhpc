...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=116";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=116";
import { swapContent } from "./socle.mjs?v=116";

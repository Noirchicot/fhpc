...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=44";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=44";
import { swapContent } from "./socle.mjs?v=44";

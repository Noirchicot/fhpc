...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=43";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=43";
import { swapContent } from "./socle.mjs?v=43";

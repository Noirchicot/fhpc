...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=273";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=273";
import { swapContent } from "./socle.mjs?v=273";

...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=190";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=190";
import { swapContent } from "./socle.mjs?v=190";

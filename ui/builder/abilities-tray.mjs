...
import { mount, createDieHost, rollDurationMs } from "./dice3d.mjs?v=120";
import { mecaniqueDeJet, rollAbilityBatch } from "./dice.mjs?v=120";
import { swapContent } from "./socle.mjs?v=120";

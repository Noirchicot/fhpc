...
import * as D from "./x1-disposition.mjs?v=814";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=814";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=814";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=814` sont DEUX instances de module. Les mêmes organes y

...
import * as D from "./x1-disposition.mjs?v=807";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=807";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=807";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=807";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=807` sont DEUX instances de module. Les mêmes organes y

...
import * as D from "./x1-disposition.mjs?v=808";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=808";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=808";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=808";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=808` sont DEUX instances de module. Les mêmes organes y

...
import { DESTINATIONS } from "./gear-ecran.mjs?v=825";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=825";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=825";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=825` sont DEUX instances de module. Les mêmes organes y

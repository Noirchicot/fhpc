...
import * as D from "./x1-disposition.mjs?v=810";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=810";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=810";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=810` sont DEUX instances de module. Les mêmes organes y

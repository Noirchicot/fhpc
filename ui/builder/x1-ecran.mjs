...
import * as D from "./x1-disposition.mjs?v=799";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=799";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=799";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=799";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=799` sont DEUX instances de module. Les mêmes organes y

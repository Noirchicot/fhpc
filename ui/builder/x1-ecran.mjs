...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=829";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=829";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=829` sont DEUX instances de module. Les mêmes organes y

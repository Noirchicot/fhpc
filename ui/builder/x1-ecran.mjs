...
import * as D from "./x1-disposition.mjs?v=817";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=817";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=817";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=817` sont DEUX instances de module. Les mêmes organes y

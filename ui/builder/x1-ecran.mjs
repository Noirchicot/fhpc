...
import * as D from "./x1-disposition.mjs?v=823";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=823";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=823";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=823";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=823` sont DEUX instances de module. Les mêmes organes y

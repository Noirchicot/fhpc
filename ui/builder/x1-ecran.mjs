...
import * as D from "./x1-disposition.mjs?v=845";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=845";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=845";
...
import { PLAFOND_HARMONISATION } from "../../src/build/effets-objets.mjs?v=845";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=845` sont DEUX instances de module. Les mêmes organes y

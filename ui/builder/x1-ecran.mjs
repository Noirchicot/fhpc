...
import * as D from "./x1-disposition.mjs?v=792";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=792";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=792";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=792";
...
import { habilleEnParchemin } from "./parchemin.mjs?v=792";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=792` sont DEUX instances de module. Les mêmes organes y

...
import * as D from "./x1-disposition.mjs?v=811";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=811";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=811";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=811";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=811` sont DEUX instances de module. Les mêmes organes y

...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=848";
...
import { PLAFOND_HARMONISATION } from "../../src/build/effets-objets.mjs?v=848";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=848` sont DEUX instances de module. Les mêmes organes y

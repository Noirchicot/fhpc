...
import * as D from "./x1-disposition.mjs?v=816";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=816";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=816";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=816";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=816` sont DEUX instances de module. Les mêmes organes y

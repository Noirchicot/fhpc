...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=827";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=827";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=827` sont DEUX instances de module. Les mêmes organes y

...
import * as D from "./x1-disposition.mjs?v=793";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=793";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=793";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=793";
...
import { habilleEnParchemin } from "./parchemin.mjs?v=793";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=793` sont DEUX instances de module. Les mêmes organes y

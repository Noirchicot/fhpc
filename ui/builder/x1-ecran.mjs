...
import * as D from "./x1-disposition.mjs?v=846";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=846";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=846";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=846";
...
import { PLAFOND_HARMONISATION } from "../../src/build/effets-objets.mjs?v=846";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=846` sont DEUX instances de module. Les mêmes organes y

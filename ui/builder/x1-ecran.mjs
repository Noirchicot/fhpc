...
import * as D from "./x1-disposition.mjs?v=813";
...
import { pisteDInterrupteur } from "./interrupteur-organe.mjs?v=813";
...
import { veilleLeDebordement } from "./defilement-chevrons.mjs?v=813";
...
/* ⛔ L'APPARTENANCE SE DIT PAR NOM, JAMAIS PAR IDENTITÉ D'OBJET — 📏 mesuré au lot
   ...
   `x1-disposition.mjs?v=813` sont DEUX instances de module. Les mêmes organes y

...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=825";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=825";
import { BARRE } from "./b3-disposition.mjs?v=825";

...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=618";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=618";
import { BARRE } from "./b3-disposition.mjs?v=618";

...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=575";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=575";
import { BARRE } from "./b3-disposition.mjs?v=575";

...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=299";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=299";
import { BARRE } from "./b3-disposition.mjs?v=299";

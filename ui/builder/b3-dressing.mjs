...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=422";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=422";
import { BARRE } from "./b3-disposition.mjs?v=422";

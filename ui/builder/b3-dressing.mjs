...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=335";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=335";
import { BARRE } from "./b3-disposition.mjs?v=335";

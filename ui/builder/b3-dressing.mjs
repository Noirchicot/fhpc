...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=843";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=843";
import { BARRE } from "./b3-disposition.mjs?v=843";

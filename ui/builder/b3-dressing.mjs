...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=638";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=638";
import { BARRE } from "./b3-disposition.mjs?v=638";

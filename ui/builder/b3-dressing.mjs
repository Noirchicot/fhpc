...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=629";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=629";
import { BARRE } from "./b3-disposition.mjs?v=629";

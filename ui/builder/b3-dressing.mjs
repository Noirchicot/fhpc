...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=571";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=571";
import { BARRE } from "./b3-disposition.mjs?v=571";

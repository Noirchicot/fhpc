...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=609";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=609";
import { BARRE } from "./b3-disposition.mjs?v=609";

...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=845";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=845";
import { BARRE } from "./b3-disposition.mjs?v=845";

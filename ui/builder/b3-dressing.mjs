...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=848";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=848";
import { BARRE } from "./b3-disposition.mjs?v=848";

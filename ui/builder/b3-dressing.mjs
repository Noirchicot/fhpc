...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=442";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=442";
import { BARRE } from "./b3-disposition.mjs?v=442";

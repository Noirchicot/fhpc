...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=728";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=728";
import { BARRE } from "./b3-disposition.mjs?v=728";

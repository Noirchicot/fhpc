...
import { construireLaSceneB3 } from "./b3-scene.mjs?v=596";
import { rangeeEchange, lignesParLieu } from "./equipement-pipeline.mjs?v=596";
import { BARRE } from "./b3-disposition.mjs?v=596";

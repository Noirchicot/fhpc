...
import { planAt } from "./carnet.mjs?v=848";
import { lignageChoisi } from "./species-step.mjs?v=848";
...
import { renderFicheTemporaire, MOTS_FICHE } from "./fiche-temporaire.mjs?v=848";

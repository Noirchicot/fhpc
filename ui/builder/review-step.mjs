...
import { planAt } from "./carnet.mjs?v=845";
import { lignageChoisi } from "./species-step.mjs?v=845";
...
import { renderFicheTemporaire, MOTS_FICHE } from "./fiche-temporaire.mjs?v=845";

...
import { renderPicker } from "./carnet.mjs?v=419";
import { facteurZoom } from "./echelle.mjs?v=419";
...
import { isGenre } from "../../src/layers/document.mjs?v=419";
import { swapContent } from "./socle.mjs?v=419";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=419";
...
import { parseCout, currentCartLines, cartCompte, lignesParLieu, poidsParLieu,
  renderB1, renderB2, renderSacs, renderRecherche } from "./equipement-pipeline.mjs?v=419";
import { SLOT_VERS_BOITES, POCHES_DEBORD } from "./b3-disposition.mjs?v=419";

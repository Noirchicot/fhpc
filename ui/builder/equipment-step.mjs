...
import { renderPicker } from "./carnet.mjs?v=420";
import { facteurZoom } from "./echelle.mjs?v=420";
...
import { isGenre } from "../../src/layers/document.mjs?v=420";
import { swapContent } from "./socle.mjs?v=420";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=420";
...
import { parseCout, currentCartLines, cartCompte, lignesParLieu, poidsParLieu,
  renderB1, renderB2, renderSacs, renderRecherche } from "./equipement-pipeline.mjs?v=420";
import { SLOT_VERS_BOITES, POCHES_DEBORD } from "./b3-disposition.mjs?v=420";

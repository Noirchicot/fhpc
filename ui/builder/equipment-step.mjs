...
import { renderPicker } from "./carnet.mjs?v=547";
import { facteurZoomCourant } from "./echelle.mjs?v=547";
...
import { isGenre } from "../../src/layers/document.mjs?v=547";
import { swapContent } from "./socle.mjs?v=547";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=547";
...
import { construireLeDressing } from "./b3-dressing.mjs?v=547";
...
import { parseCout, currentCartLines, cartCompte, lignesParLieu, poidsParLieu,
  renderB1, renderB2, renderSacs, renderRecherche } from "./equipement-pipeline.mjs?v=547";
import { SLOT_VERS_BOITES, POCHES_DEBORD } from "./b3-disposition.mjs?v=547";

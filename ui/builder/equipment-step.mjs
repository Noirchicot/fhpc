...
import { renderPicker } from "./carnet.mjs?v=556";
import { facteurZoomCourant } from "./echelle.mjs?v=556";
...
import { isGenre } from "../../src/layers/document.mjs?v=556";
import { swapContent } from "./socle.mjs?v=556";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=556";
...
import { construireLeDressing } from "./b3-dressing.mjs?v=556";
...
import { parseCout, currentCartLines, cartCompte, lignesParLieu, poidsParLieu,
  renderB1, renderB2, renderSacs, renderRecherche } from "./equipement-pipeline.mjs?v=556";
import { SLOT_VERS_BOITES, POCHES_DEBORD } from "./b3-disposition.mjs?v=556";

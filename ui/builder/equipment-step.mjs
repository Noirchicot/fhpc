...
import { renderPicker } from "./carnet.mjs?v=329";
...
import { isGenre } from "../../src/layers/document.mjs?v=329";
import { swapContent } from "./socle.mjs?v=329";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=329";
...
import { parseCout, currentCartLines, cartCompte, lignesParLieu, poidsParLieu,
  renderB1, renderB2, renderSacs, renderRecherche } from "./equipement-pipeline.mjs?v=329";
import { SLOT_VERS_BOITES, POCHES_DEBORD } from "./b3-disposition.mjs?v=329";

...
import { renderPicker } from "./carnet.mjs?v=354";
...
import { isGenre } from "../../src/layers/document.mjs?v=354";
import { swapContent } from "./socle.mjs?v=354";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=354";
...
import { parseCout, currentCartLines, cartCompte, lignesParLieu, poidsParLieu,
  renderB1, renderB2, renderSacs, renderRecherche } from "./equipement-pipeline.mjs?v=354";
import { SLOT_VERS_BOITES, POCHES_DEBORD } from "./b3-disposition.mjs?v=354";

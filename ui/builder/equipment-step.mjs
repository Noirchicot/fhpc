...
import { renderPicker } from "./carnet.mjs?v=606";
...
import { isGenre } from "../../src/layers/document.mjs?v=606";
import { swapContent } from "./socle.mjs?v=606";
import { LISTE_PAR_PAGE, pageDeListe } from "./normes.mjs?v=606";

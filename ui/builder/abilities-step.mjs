...
import { markPressed } from "./carnet.mjs?v=342";
import { renderTray } from "./abilities-tray.mjs?v=342";
import { armerJeton } from "./glisser.mjs?v=342";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=342";
import { createDieHost, mount } from "./dice3d.mjs?v=342";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=342";

...
import { renderTray } from "./abilities-tray.mjs?v=445";
import { armerJeton } from "./glisser.mjs?v=445";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=445";
import { createDieHost, mount } from "./dice3d.mjs?v=445";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=445";

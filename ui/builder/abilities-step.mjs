...
import { markPressed } from "./carnet.mjs?v=797";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=797";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=797";
import { armerJeton } from "./glisser.mjs?v=797";
import { facteurZoomCourant } from "./echelle.mjs?v=797";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=797";
import { createDieHost, mount } from "./dice3d.mjs?v=797";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=797";

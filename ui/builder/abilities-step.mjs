...
import { markPressed } from "./carnet.mjs?v=836";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=836";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=836";
import { armerJeton } from "./glisser.mjs?v=836";
import { facteurZoomCourant } from "./echelle.mjs?v=836";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=836";
import { createDieHost, mount } from "./dice3d.mjs?v=836";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=836";

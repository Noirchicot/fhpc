...
import { markPressed } from "./carnet.mjs?v=405";
import { renderTray } from "./abilities-tray.mjs?v=405";
import { armerJeton } from "./glisser.mjs?v=405";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=405";
import { createDieHost, mount } from "./dice3d.mjs?v=405";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=405";

...
import { markPressed } from "./carnet.mjs?v=699";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=699";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=699";
import { armerJeton } from "./glisser.mjs?v=699";
import { facteurZoomCourant } from "./echelle.mjs?v=699";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=699";
import { createDieHost, mount } from "./dice3d.mjs?v=699";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=699";

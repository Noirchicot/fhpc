...
import { markPressed } from "./carnet.mjs?v=255";
import { renderTray } from "./abilities-tray.mjs?v=255";
import { armerJeton } from "./glisser.mjs?v=255";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=255";
import { createDieHost, mount } from "./dice3d.mjs?v=255";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=255";

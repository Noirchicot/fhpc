...
import { markPressed } from "./carnet.mjs?v=832";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=832";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=832";
import { armerJeton } from "./glisser.mjs?v=832";
import { facteurZoomCourant } from "./echelle.mjs?v=832";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=832";
import { createDieHost, mount } from "./dice3d.mjs?v=832";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=832";

...
import { markPressed } from "./carnet.mjs?v=299";
import { renderTray } from "./abilities-tray.mjs?v=299";
import { armerJeton } from "./glisser.mjs?v=299";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=299";
import { createDieHost, mount } from "./dice3d.mjs?v=299";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=299";

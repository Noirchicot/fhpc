...
import { renderTray } from "./abilities-tray.mjs?v=448";
import { armerJeton } from "./glisser.mjs?v=448";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=448";
import { createDieHost, mount } from "./dice3d.mjs?v=448";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=448";

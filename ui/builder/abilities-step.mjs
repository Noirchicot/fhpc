...
import { markPressed } from "./carnet.mjs?v=322";
import { renderTray } from "./abilities-tray.mjs?v=322";
import { armerJeton } from "./glisser.mjs?v=322";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=322";
import { createDieHost, mount } from "./dice3d.mjs?v=322";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=322";

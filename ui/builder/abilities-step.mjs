...
import { markPressed } from "./carnet.mjs?v=616";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=616";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=616";
import { armerJeton } from "./glisser.mjs?v=616";
import { facteurZoomCourant } from "./echelle.mjs?v=616";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=616";
import { createDieHost, mount } from "./dice3d.mjs?v=616";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=616";

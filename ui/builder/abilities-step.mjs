...
import { markPressed } from "./carnet.mjs?v=706";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=706";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=706";
import { armerJeton } from "./glisser.mjs?v=706";
import { facteurZoomCourant } from "./echelle.mjs?v=706";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=706";
import { createDieHost, mount } from "./dice3d.mjs?v=706";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=706";

...
import { markPressed } from "./carnet.mjs?v=764";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=764";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=764";
import { armerJeton } from "./glisser.mjs?v=764";
import { facteurZoomCourant } from "./echelle.mjs?v=764";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=764";
import { createDieHost, mount } from "./dice3d.mjs?v=764";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=764";

...
import { markPressed } from "./carnet.mjs?v=779";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=779";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=779";
import { armerJeton } from "./glisser.mjs?v=779";
import { facteurZoomCourant } from "./echelle.mjs?v=779";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=779";
import { createDieHost, mount } from "./dice3d.mjs?v=779";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=779";

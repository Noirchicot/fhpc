...
import { markPressed } from "./carnet.mjs?v=426";
import { renderTray } from "./abilities-tray.mjs?v=426";
import { armerJeton } from "./glisser.mjs?v=426";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=426";
import { createDieHost, mount } from "./dice3d.mjs?v=426";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=426";

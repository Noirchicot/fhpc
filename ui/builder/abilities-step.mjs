...
import { renderPicker, markPressed } from "./carnet.mjs?v=3";
import { renderTray } from "./abilities-tray.mjs?v=3";
import { ROLLING_METHODS } from "./dice.mjs?v=3";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=3";
import { rollAbilitySet } from "./dice.mjs?v=3";

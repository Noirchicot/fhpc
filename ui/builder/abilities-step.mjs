...
import { markPressed } from "./carnet.mjs?v=336";
import { renderTray } from "./abilities-tray.mjs?v=336";
import { armerJeton } from "./glisser.mjs?v=336";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=336";
import { createDieHost, mount } from "./dice3d.mjs?v=336";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=336";

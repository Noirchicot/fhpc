...
import { markPressed } from "./carnet.mjs?v=784";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=784";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=784";
import { armerJeton } from "./glisser.mjs?v=784";
import { facteurZoomCourant } from "./echelle.mjs?v=784";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=784";
import { createDieHost, mount } from "./dice3d.mjs?v=784";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=784";

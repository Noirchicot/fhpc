...
import { markPressed } from "./carnet.mjs?v=417";
import { renderTray } from "./abilities-tray.mjs?v=417";
import { armerJeton } from "./glisser.mjs?v=417";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=417";
import { createDieHost, mount } from "./dice3d.mjs?v=417";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=417";

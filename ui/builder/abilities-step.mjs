...
import { markPressed } from "./carnet.mjs?v=648";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=648";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=648";
import { armerJeton } from "./glisser.mjs?v=648";
import { facteurZoomCourant } from "./echelle.mjs?v=648";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=648";
import { createDieHost, mount } from "./dice3d.mjs?v=648";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=648";

...
import { markPressed } from "./carnet.mjs?v=829";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=829";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=829";
import { armerJeton } from "./glisser.mjs?v=829";
import { facteurZoomCourant } from "./echelle.mjs?v=829";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=829";
import { createDieHost, mount } from "./dice3d.mjs?v=829";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=829";

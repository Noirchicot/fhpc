...
import { markPressed } from "./carnet.mjs?v=606";
import { lienAbilityScoresFhWeb } from "./liens-fh.mjs?v=606";
import { renderTray, poserUnDe, LIBELLES } from "./abilities-tray.mjs?v=606";
import { armerJeton } from "./glisser.mjs?v=606";
import { facteurZoomCourant } from "./echelle.mjs?v=606";
import { mecaniqueDeJet, rollAbilitySet } from "./dice.mjs?v=606";
import { createDieHost, mount } from "./dice3d.mjs?v=606";
import { ABILITY_KEYS, CREATION_SCORES, CREATION_SCORE_MAX } from "../../src/build/index.mjs?v=606";

...
import { planAt, violationAt, markPressed, decisionRefusalWord } from "./carnet.mjs?v=692";
import { lienSkillFhWeb } from "./liens-fh.mjs?v=692";
...
import { motDuChoix } from "./mot-du-choix.mjs?v=692";
...
import { motDuManque, CAUSE_SANS_RAISON } from "./ecran-mort.mjs?v=692";

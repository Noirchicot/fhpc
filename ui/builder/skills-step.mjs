...
import { planAt, violationAt, markPressed, decisionRefusalWord } from "./carnet.mjs?v=624";
import { lienSkillFhWeb } from "./liens-fh.mjs?v=624";
...
import { motDuManque, CAUSE_SANS_RAISON } from "./ecran-mort.mjs?v=624";

...
import { planAt, violationAt, markPressed, decisionRefusalWord } from "./carnet.mjs?v=619";
import { lienSkillFhWeb } from "./liens-fh.mjs?v=619";
...
import { motDuChoix } from "./mot-du-choix.mjs?v=619";

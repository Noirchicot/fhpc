...
import { planAt, violationAt, markPressed, decisionRefusalWord } from "./carnet.mjs?v=786";
import { lienSkillFhWeb } from "./liens-fh.mjs?v=786";
...
import { motDuChoix } from "./mot-du-choix.mjs?v=786";
...
import { motDuManque, CAUSE_SANS_RAISON } from "./ecran-mort.mjs?v=786";

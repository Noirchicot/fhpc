...
import * as D from "./x1-disposition.mjs?v=830";
/* ⭐ LA TÊTE, ENTIÈRE, PAR UN SEUL APPEL — ⛔ aucun de ces trois n'est réécrit ici. */
import { construireLaTeteDeFiche, feuilleDesCotesDeTete, BAS_DE_TETE, texteDeLUnite, remplirLaDescription } from "./x1-ecran.mjs?v=830";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=830";
...
import { parseCout, multiplieCout, bourseCouvre } from "./equipement-pipeline.mjs?v=830";

...
import { construireLaTeteDeFiche, feuilleDesCotesDeTete, BAS_DE_TETE } from "./x1-ecran.mjs?v=809";
...
import { parseCout, multiplieCout, bourseCouvre } from "./equipement-pipeline.mjs?v=809";

...
import { construireLaTeteDeFiche, feuilleDesCotesDeTete, BAS_DE_TETE, texteDeLUnite, remplirLaDescription } from "./x1-ecran.mjs?v=844";
...
import { parseCout, multiplieCout, bourseCouvre } from "./equipement-pipeline.mjs?v=844";

...
import * as D from "./x1-disposition.mjs?v=821";
/* ⭐ LA TÊTE, ENTIÈRE, PAR UN SEUL APPEL — ⛔ aucun de ces trois n'est réécrit ici. */
import { construireLaTeteDeFiche, feuilleDesCotesDeTete, BAS_DE_TETE } from "./x1-ecran.mjs?v=821";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=821";
...
import { parseCout, multiplieCout, bourseCouvre } from "./equipement-pipeline.mjs?v=821";

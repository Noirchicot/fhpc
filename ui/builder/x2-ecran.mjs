...
import * as D from "./x1-disposition.mjs?v=828";
/* ⭐ LA TÊTE, ENTIÈRE, PAR UN SEUL APPEL — ⛔ aucun de ces trois n'est réécrit ici. */
import { construireLaTeteDeFiche, feuilleDesCotesDeTete, BAS_DE_TETE, texteDeLUnite, remplirLaDescription } from "./x1-ecran.mjs?v=828";
...
import { DESTINATIONS } from "./gear-ecran.mjs?v=828";
...
import { parseCout, multiplieCout, bourseCouvre } from "./equipement-pipeline.mjs?v=828";

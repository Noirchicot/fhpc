...
import { DALLE, DALLES, EDITION, MARGE, TOUCH, JETON, ROUE, COLONNES, RANGEES, ORGANES, FOND } from "./sac-disposition.mjs?v=787";
import { versionQuery } from "./version.mjs?v=787";
import { corpsDuJeton, motDuJeton } from "./jeton-objet.mjs?v=787";
/* ⭐ LE MÉCANISME DE LA ROUE — module feuille (lot 218), parce que Wares en porte DEUX. */
import { monterLeTambour, coteDeLaCale } from "./roue-tambour.mjs?v=787";
...
import { armerJeton, fantome } from "./glisser.mjs?v=787";
...
import { popupDeLaBourse, reglesDeLaBourse, montantDeLaBourse } from "./gear-ecran.mjs?v=787";

...
import { DALLE, MARGE, TOUCH, JETON, ROUE, COLONNES, ORGANES, FOND } from "./sac-disposition.mjs?v=728";
import { versionQuery } from "./version.mjs?v=728";
import { corpsDuJeton, motDuJeton } from "./jeton-objet.mjs?v=728";
...
import { armerJeton, fantome } from "./glisser.mjs?v=728";
...
import { popupDeLaBourse } from "./gear-ecran.mjs?v=728";

...
import { DALLE, DALLES, EDITION, MARGE, TOUCH, JETON, ROUE, COLONNES, RANGEES, ORGANES, FOND } from "./sac-disposition.mjs?v=841";
import { versionQuery } from "./version.mjs?v=841";
import { corpsDuJeton, motDuJeton } from "./jeton-objet.mjs?v=841";
/* ⭐ LE MÉCANISME DE LA ROUE — module feuille (lot 218), parce que Wares en porte DEUX. */
import { monterLeTambour, coteDeLaCale } from "./roue-tambour.mjs?v=841";
...
import { armerJeton, fantome } from "./glisser.mjs?v=841";
...
import { popupDeLaBourse, reglesDeLaBourse, montantDeLaBourse } from "./gear-ecran.mjs?v=841";

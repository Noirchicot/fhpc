...
import { raretesDuParchemin, nomDUnParchemin } from "../../src/build/objet-crafte.mjs?v=833";
import { scribingDuNiveau, noteDeScribing } from "./bareme-srfh.mjs?v=833";
import { PLAFOND_QTE, texteDesJours } from "./craft.mjs?v=833";

...
import { raretesDuParchemin, nomDUnParchemin } from "../../src/build/objet-crafte.mjs?v=839";
import { scribingDuNiveau, noteDeScribing } from "./bareme-srfh.mjs?v=839";
import { PLAFOND_QTE, texteDesJours } from "./craft.mjs?v=839";

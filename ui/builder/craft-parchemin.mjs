...
import { raretesDuParchemin, nomDUnParchemin } from "../../src/build/objet-crafte.mjs?v=837";
import { scribingDuNiveau, noteDeScribing } from "./bareme-srfh.mjs?v=837";
import { PLAFOND_QTE, texteDesJours } from "./craft.mjs?v=837";

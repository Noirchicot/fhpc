...
import { raretesDuParchemin, nomDUnParchemin } from "../../src/build/objet-crafte.mjs?v=836";
import { scribingDuNiveau, noteDeScribing } from "./bareme-srfh.mjs?v=836";
import { PLAFOND_QTE, texteDesJours } from "./craft.mjs?v=836";

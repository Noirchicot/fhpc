...
export async function bootEngine({ root = "../.." } = {}) {
  const { createLayers } = await import("../../src/layers/index.mjs?v=624");
  const { createBuild } = await import("../../src/build/index.mjs?v=624");
  const { createFhDestinyStat } = await import("../../src/modules/fh/destiny-stat.mjs?v=624");
  const { createFhSkillPoolStat } = await import("../../src/modules/fh/skill-pool.mjs?v=624");
  ...
  const { createFhSpeciesTraits } = await import("../../src/modules/fh/species-traits.mjs?v=624");

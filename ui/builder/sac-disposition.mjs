...
export const RANGEES = [108, 164, 220, 276];

export const ORGANES = [
  { nom: "ROUE",        sorte: "roue",     x:     22, y:      4, l:    331, h:    40, cible: { x: 22, y: 2, l: 331, h: 44 }, cran: "T1/600" },
  { nom: "CRAN 1",      sorte: "cran",     x:     22, y:      6, l:     57, h:    36, dans: "ROUE", mot: "Section 1", cran: "T0/600" },
  { nom: "CRAN 2",      sorte: "cran",     x:     87, y:      6, l:     57, h:    36, dans: "ROUE", mot: "Section 2", cran: "T0/600" },
  { nom: "CRAN 3",      sorte: "cran",     x:    152, y:      4, l:     71, h:    40, dans: "ROUE", mot: "Potions", cran: "T1/600", dominant: true },
  { nom: "CRAN 4",      sorte: "cran",     x:    231, y:      6, l:     57, h:    36, dans: "ROUE", mot: "Section 4", cran: "T0/600" },
  { nom: "CRAN 5",      sorte: "cran",     x:    296, y:      6, l:     57, h:    36, dans: "ROUE", mot: "Section 5", cran: "T0/600" },
  { nom: "TUNER G",     sorte: "tuner",    x:      4, y:     14, l:     10, h:    20, cible: { x: -13, y: 2, l: 44, h: 44 }, dans: "ROUE" },
  { nom: "TUNER D",     sorte: "tuner",    x:    361, y:     14, l:     10, h:    20, cible: { x: 344, y: 2, l: 44, h: 44 }, dans: "ROUE" },
  ...
  { nom: "POIDS 4",     sorte: "voyant",   x:     52, y:     89, l:    271, h:    10, mot: "Other — 3 obj. · 61 lb", cran: "T0/400" },
  { nom: "CASE 1.1",    sorte: "jeton",    x:     49, y:    108, l:     87, h:    48 },
  { nom: "CASE 1.2",    sorte: "jeton",    x:    144, y:    108, l:     87, h:    48 },
  { nom: "CASE 1.3",    sorte: "jeton",    x:    239, y:    108, l:     87, h:    48 },
  { nom: "CASE 2.1",    sorte: "jeton",    x:     49, y:    164, l:     87, h:    48 },
  { nom: "CASE 2.2",    sorte: "jeton",    x:    144, y:    164, l:     87, h:    48 },
  { nom: "CASE 2.3",    sorte: "jeton",    x:    239, y:    164, l:     87, h:    48 },
  { nom: "CASE 3.1",    sorte: "jeton",    x:     49, y:    220, l:     87, h:    48 },
  { nom: "CASE 3.2",    sorte: "jeton",    x:    144, y:    220, l:     87, h:    48 },
  { nom: "CASE 3.3",    sorte: "jeton",    x:    239, y:    220, l:     87, h:    48 },
  { nom: "CASE 4.1",    sorte: "jeton",    x:     49, y:    276, l:     87, h:    48 },
  { nom: "CASE 4.2",    sorte: "jeton",    x:    144, y:    276, l:     87, h:    48 },
  { nom: "CASE 4.3",    sorte: "jeton",    x:    239, y:    276, l:     87, h:    48 },
  { nom: "lune Wares",  sorte: "lune",     x:      4, y:    157, l:     30, h:    30, cible: { x: 0, y: 150, l: 44, h: 44 }, mot: "Wares", creation: false },
  { nom: "lune Gear",   sorte: "lune",     x:      4, y:    201, l:     30, h:    30, cible: { x: 0, y: 194, l: 44, h: 44 }, mot: "Gear", creation: false },
  { nom: "lune Craft",  sorte: "lune",     x:      4, y:    245, l:     30, h:    30, cible: { x: 0, y: 238, l: 44, h: 44 }, mot: "Craft", creation: false },
  { nom: "COLLECTEUR",  sorte: "collecteur", x:    144, y:    348, l:     87, h:    48, cible: { x: 144, y: 348, l: 87, h: 48 }, mot: "SEND COLLECTOR", cran: "T1/600" },
  { nom: "COMPTE",      sorte: "voyant",   x:     49, y:    328, l:  134.5, h:    10, mot: "23 items", cran: "T0/400" },
  { nom: "PAGE",        sorte: "voyant",   x:  191.5, y:    328, l:  134.5, h:    10, mot: "1/2", cran: "T0/400" },
  { nom: "PURSE",       sorte: "bouton",   x:    276, y:    348, l:     50, h:    50, cible: { x: 276, y: 348, l: 50, h: 50 }, mot: "Purse", cran: "T1/600" },
  { nom: "PARTY TALLY", sorte: "bouton",   x:     32, y:    353, l:     40, h:    40, cible: { x: 30, y: 351, l: 44, h: 44 }, mot: "Party Tally", cran: "T1/600" },
  { nom: "TALLY",       sorte: "bouton",   x:     80, y:    353, l:     40, h:    40, cible: { x: 78, y: 351, l: 44, h: 44 }, mot: "Tally", cran: "T1/600" },

...
export const ORGANES = [
  ...
  { nom: "EDITER",      sorte: "bouton",   x:  153.5, y:     13, l:     30, h:    30, cible: { x: 146.5, y: 6, l: 44, h: 44 }, dans: "NOTICE", mot: "/", cran: "T3/600" },
  { nom: "EFFACER",     sorte: "bouton",   x:  191.5, y:     13, l:     30, h:    30, cible: { x: 184.5, y: 6, l: 44, h: 44 }, dans: "NOTICE", mot: "×", cran: "T3/600" },
  { nom: "RECULER",     sorte: "bouton",   x:  153.5, y:     51, l:     30, h:    30, cible: { x: 146.5, y: 44, l: 44, h: 44 }, dans: "NOTICE", mot: "←", cran: "T3/600" },
  ...
  { nom: "POIDS TOTAL", sorte: "voyant",   x:     56, y:     52, l:    263, h:    14, mot: "Encumbrance : 46,5", cran: "T2/600" },
  { nom: "POIDS DETAIL", sorte: "voyant",   x:     56, y:     66, l:    263, h:    22, mot: "Gear 34,5   Backpack 12   Other 61", cran: "T1/400" },

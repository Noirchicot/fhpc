...
export const ORGANES = [
  ...
  { nom: "EFFACER",     sorte: "bouton",   x:    132, y:     24, l:     40, h:    40, cible: { x: 130, y: 22, l: 44, h: 44 }, mot: "×", cran: "T3/600" },
  { nom: "EDITER",      sorte: "bouton",   x:    203, y:     24, l:     40, h:    40, cible: { x: 201, y: 22, l: 44, h: 44 }, mot: "/", cran: "T3/600" },

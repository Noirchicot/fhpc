...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=822";
import { STEPS } from "./etapes.mjs?v=822";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=822";

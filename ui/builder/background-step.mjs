...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=628";
import { STEPS } from "./etapes.mjs?v=628";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=628";

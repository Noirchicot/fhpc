...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=760";
import { STEPS } from "./etapes.mjs?v=760";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=760";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=625";
import { STEPS } from "./etapes.mjs?v=625";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=625";

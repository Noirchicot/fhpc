...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=770";
import { STEPS } from "./etapes.mjs?v=770";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=770";

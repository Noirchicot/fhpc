...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=773";
import { STEPS } from "./etapes.mjs?v=773";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=773";

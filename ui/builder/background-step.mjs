...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=787";
import { STEPS } from "./etapes.mjs?v=787";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=787";

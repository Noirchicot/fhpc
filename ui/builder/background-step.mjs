...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=820";
import { STEPS } from "./etapes.mjs?v=820";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=820";

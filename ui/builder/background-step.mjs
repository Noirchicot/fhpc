...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=808";
import { STEPS } from "./etapes.mjs?v=808";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=808";

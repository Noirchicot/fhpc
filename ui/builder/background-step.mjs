...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=750";
import { STEPS } from "./etapes.mjs?v=750";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=750";

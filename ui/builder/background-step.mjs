...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=838";
import { STEPS } from "./etapes.mjs?v=838";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=838";

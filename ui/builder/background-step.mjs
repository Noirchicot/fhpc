...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=675";
import { STEPS } from "./etapes.mjs?v=675";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=675";

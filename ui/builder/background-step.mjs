...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=677";
import { STEPS } from "./etapes.mjs?v=677";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=677";

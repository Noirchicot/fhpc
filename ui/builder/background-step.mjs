...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=676";
import { STEPS } from "./etapes.mjs?v=676";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=676";

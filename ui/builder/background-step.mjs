...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=800";
import { STEPS } from "./etapes.mjs?v=800";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=800";

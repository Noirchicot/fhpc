...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=843";
import { STEPS } from "./etapes.mjs?v=843";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=843";

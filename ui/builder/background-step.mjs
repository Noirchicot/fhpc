...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=757";
import { STEPS } from "./etapes.mjs?v=757";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=757";

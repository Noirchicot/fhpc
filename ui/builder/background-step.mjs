...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=832";
import { STEPS } from "./etapes.mjs?v=832";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=832";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=817";
import { STEPS } from "./etapes.mjs?v=817";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=817";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=815";
import { STEPS } from "./etapes.mjs?v=815";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=815";

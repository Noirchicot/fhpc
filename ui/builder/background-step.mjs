...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=774";
import { STEPS } from "./etapes.mjs?v=774";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=774";

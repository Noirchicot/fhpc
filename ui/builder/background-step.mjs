...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=752";
import { STEPS } from "./etapes.mjs?v=752";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=752";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=778";
import { STEPS } from "./etapes.mjs?v=778";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=778";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=827";
import { STEPS } from "./etapes.mjs?v=827";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=827";

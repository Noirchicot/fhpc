...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=694";
import { STEPS } from "./etapes.mjs?v=694";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=694";

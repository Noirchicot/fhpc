...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=737";
import { STEPS } from "./etapes.mjs?v=737";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=737";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=673";
import { STEPS } from "./etapes.mjs?v=673";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=673";

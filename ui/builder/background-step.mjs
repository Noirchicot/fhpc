...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=793";
import { STEPS } from "./etapes.mjs?v=793";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=793";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=635";
import { STEPS } from "./etapes.mjs?v=635";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=635";

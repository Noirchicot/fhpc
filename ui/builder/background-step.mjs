...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=638";
import { STEPS } from "./etapes.mjs?v=638";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=638";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=667";
import { STEPS } from "./etapes.mjs?v=667";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=667";

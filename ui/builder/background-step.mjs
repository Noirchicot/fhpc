...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=620";
import { STEPS } from "./etapes.mjs?v=620";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=620";

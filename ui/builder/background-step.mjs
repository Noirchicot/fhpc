...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=830";
import { STEPS } from "./etapes.mjs?v=830";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=830";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=647";
import { STEPS } from "./etapes.mjs?v=647";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=647";

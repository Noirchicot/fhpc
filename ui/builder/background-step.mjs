...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=777";
import { STEPS } from "./etapes.mjs?v=777";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=777";

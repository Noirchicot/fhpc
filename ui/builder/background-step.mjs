...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=795";
import { STEPS } from "./etapes.mjs?v=795";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=795";

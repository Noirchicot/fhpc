...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=754";
import { STEPS } from "./etapes.mjs?v=754";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=754";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=782";
import { STEPS } from "./etapes.mjs?v=782";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=782";

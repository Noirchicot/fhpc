...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=841";
import { STEPS } from "./etapes.mjs?v=841";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=841";

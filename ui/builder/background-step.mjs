...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=631";
import { STEPS } from "./etapes.mjs?v=631";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=631";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=807";
import { STEPS } from "./etapes.mjs?v=807";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=807";

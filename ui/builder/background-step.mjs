...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=806";
import { STEPS } from "./etapes.mjs?v=806";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=806";

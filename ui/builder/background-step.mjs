...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=834";
import { STEPS } from "./etapes.mjs?v=834";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=834";

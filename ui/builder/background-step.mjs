...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=831";
import { STEPS } from "./etapes.mjs?v=831";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=831";

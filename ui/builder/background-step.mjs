...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=798";
import { STEPS } from "./etapes.mjs?v=798";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=798";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=651";
import { STEPS } from "./etapes.mjs?v=651";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=651";

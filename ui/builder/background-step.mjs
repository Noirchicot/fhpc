...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=707";
import { STEPS } from "./etapes.mjs?v=707";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=707";

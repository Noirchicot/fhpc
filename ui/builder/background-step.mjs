...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=722";
import { STEPS } from "./etapes.mjs?v=722";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=722";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=799";
import { STEPS } from "./etapes.mjs?v=799";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=799";

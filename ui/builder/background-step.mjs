...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=636";
import { STEPS } from "./etapes.mjs?v=636";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=636";

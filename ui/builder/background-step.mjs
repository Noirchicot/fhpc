...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=814";
import { STEPS } from "./etapes.mjs?v=814";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=814";

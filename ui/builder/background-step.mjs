...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=788";
import { STEPS } from "./etapes.mjs?v=788";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=788";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=655";
import { STEPS } from "./etapes.mjs?v=655";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=655";

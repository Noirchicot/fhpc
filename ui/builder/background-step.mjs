...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=741";
import { STEPS } from "./etapes.mjs?v=741";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=741";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=824";
import { STEPS } from "./etapes.mjs?v=824";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=824";

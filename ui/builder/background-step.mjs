...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=810";
import { STEPS } from "./etapes.mjs?v=810";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=810";

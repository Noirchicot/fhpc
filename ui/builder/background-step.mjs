...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=645";
import { STEPS } from "./etapes.mjs?v=645";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=645";

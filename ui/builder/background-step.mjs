...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=805";
import { STEPS } from "./etapes.mjs?v=805";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=805";

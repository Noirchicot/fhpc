...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=767";
import { STEPS } from "./etapes.mjs?v=767";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=767";

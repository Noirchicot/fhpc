...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=819";
import { STEPS } from "./etapes.mjs?v=819";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=819";

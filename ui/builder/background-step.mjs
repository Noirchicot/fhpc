...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=652";
import { STEPS } from "./etapes.mjs?v=652";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=652";

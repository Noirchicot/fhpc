...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=842";
import { STEPS } from "./etapes.mjs?v=842";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=842";

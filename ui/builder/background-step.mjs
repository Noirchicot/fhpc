...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=657";
import { STEPS } from "./etapes.mjs?v=657";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=657";

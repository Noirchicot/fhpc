...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=846";
import { STEPS } from "./etapes.mjs?v=846";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=846";

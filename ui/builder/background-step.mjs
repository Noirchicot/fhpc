...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=731";
import { STEPS } from "./etapes.mjs?v=731";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=731";

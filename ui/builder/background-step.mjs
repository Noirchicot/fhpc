...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=801";
import { STEPS } from "./etapes.mjs?v=801";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=801";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=692";
import { STEPS } from "./etapes.mjs?v=692";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=692";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=796";
import { STEPS } from "./etapes.mjs?v=796";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=796";

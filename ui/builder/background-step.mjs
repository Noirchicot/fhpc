...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=730";
import { STEPS } from "./etapes.mjs?v=730";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=730";

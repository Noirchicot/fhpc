...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=836";
import { STEPS } from "./etapes.mjs?v=836";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=836";

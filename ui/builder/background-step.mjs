...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=634";
import { STEPS } from "./etapes.mjs?v=634";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=634";

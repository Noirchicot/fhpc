...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=775";
import { STEPS } from "./etapes.mjs?v=775";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=775";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=789";
import { STEPS } from "./etapes.mjs?v=789";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=789";

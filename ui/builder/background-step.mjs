...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=829";
import { STEPS } from "./etapes.mjs?v=829";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=829";

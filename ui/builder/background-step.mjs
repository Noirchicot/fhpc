...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=642";
import { STEPS } from "./etapes.mjs?v=642";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=642";

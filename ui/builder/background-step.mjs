...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=797";
import { STEPS } from "./etapes.mjs?v=797";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=797";

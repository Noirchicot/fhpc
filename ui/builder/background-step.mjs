...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=729";
import { STEPS } from "./etapes.mjs?v=729";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=729";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=630";
import { STEPS } from "./etapes.mjs?v=630";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=630";

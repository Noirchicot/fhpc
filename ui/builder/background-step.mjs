...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=618";
import { STEPS } from "./etapes.mjs?v=618";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=618";

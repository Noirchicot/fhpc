...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=765";
import { STEPS } from "./etapes.mjs?v=765";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=765";

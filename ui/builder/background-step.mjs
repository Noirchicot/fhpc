...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=768";
import { STEPS } from "./etapes.mjs?v=768";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=768";

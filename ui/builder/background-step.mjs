...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=640";
import { STEPS } from "./etapes.mjs?v=640";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=640";

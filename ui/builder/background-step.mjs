...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=839";
import { STEPS } from "./etapes.mjs?v=839";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=839";

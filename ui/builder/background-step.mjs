...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=823";
import { STEPS } from "./etapes.mjs?v=823";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=823";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=686";
import { STEPS } from "./etapes.mjs?v=686";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=686";

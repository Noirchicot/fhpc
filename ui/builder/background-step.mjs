...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=794";
import { STEPS } from "./etapes.mjs?v=794";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=794";

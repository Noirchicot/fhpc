...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=654";
import { STEPS } from "./etapes.mjs?v=654";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=654";

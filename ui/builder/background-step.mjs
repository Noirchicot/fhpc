...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=845";
import { STEPS } from "./etapes.mjs?v=845";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=845";

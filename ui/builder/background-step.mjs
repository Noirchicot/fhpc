...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=646";
import { STEPS } from "./etapes.mjs?v=646";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=646";

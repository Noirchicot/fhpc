...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=699";
import { STEPS } from "./etapes.mjs?v=699";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=699";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=623";
import { STEPS } from "./etapes.mjs?v=623";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=623";

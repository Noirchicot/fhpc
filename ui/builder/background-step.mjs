...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=762";
import { STEPS } from "./etapes.mjs?v=762";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=762";

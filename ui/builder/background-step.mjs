...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=735";
import { STEPS } from "./etapes.mjs?v=735";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=735";

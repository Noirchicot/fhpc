...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=660";
import { STEPS } from "./etapes.mjs?v=660";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=660";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=811";
import { STEPS } from "./etapes.mjs?v=811";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=811";

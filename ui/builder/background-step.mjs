...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=619";
import { STEPS } from "./etapes.mjs?v=619";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=619";

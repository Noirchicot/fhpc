...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=816";
import { STEPS } from "./etapes.mjs?v=816";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=816";

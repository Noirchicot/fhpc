...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=847";
import { STEPS } from "./etapes.mjs?v=847";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=847";

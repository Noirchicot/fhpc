...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=804";
import { STEPS } from "./etapes.mjs?v=804";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=804";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=837";
import { STEPS } from "./etapes.mjs?v=837";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=837";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=781";
import { STEPS } from "./etapes.mjs?v=781";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=781";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=639";
import { STEPS } from "./etapes.mjs?v=639";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=639";

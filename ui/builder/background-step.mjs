...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=747";
import { STEPS } from "./etapes.mjs?v=747";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=747";

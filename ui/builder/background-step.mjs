...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=844";
import { STEPS } from "./etapes.mjs?v=844";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=844";

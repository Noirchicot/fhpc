...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=828";
import { STEPS } from "./etapes.mjs?v=828";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=828";

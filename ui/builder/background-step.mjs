...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=812";
import { STEPS } from "./etapes.mjs?v=812";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=812";

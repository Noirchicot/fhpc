...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=697";
import { STEPS } from "./etapes.mjs?v=697";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=697";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=648";
import { STEPS } from "./etapes.mjs?v=648";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=648";

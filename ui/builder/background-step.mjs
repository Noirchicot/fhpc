...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=670";
import { STEPS } from "./etapes.mjs?v=670";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=670";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=802";
import { STEPS } from "./etapes.mjs?v=802";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=802";

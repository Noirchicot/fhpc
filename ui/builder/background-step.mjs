...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=746";
import { STEPS } from "./etapes.mjs?v=746";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=746";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=621";
import { STEPS } from "./etapes.mjs?v=621";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=621";

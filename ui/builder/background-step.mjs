...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=622";
import { STEPS } from "./etapes.mjs?v=622";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=622";

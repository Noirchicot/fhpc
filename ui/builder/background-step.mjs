...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=766";
import { STEPS } from "./etapes.mjs?v=766";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=766";

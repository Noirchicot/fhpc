...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=784";
import { STEPS } from "./etapes.mjs?v=784";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=784";

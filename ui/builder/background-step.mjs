...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=739";
import { STEPS } from "./etapes.mjs?v=739";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=739";

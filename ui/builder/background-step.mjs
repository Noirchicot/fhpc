...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=818";
import { STEPS } from "./etapes.mjs?v=818";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=818";

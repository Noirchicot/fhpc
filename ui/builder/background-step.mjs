...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=650";
import { STEPS } from "./etapes.mjs?v=650";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=650";

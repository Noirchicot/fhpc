...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=748";
import { STEPS } from "./etapes.mjs?v=748";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=748";

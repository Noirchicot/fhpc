...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=745";
import { STEPS } from "./etapes.mjs?v=745";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=745";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=826";
import { STEPS } from "./etapes.mjs?v=826";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=826";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=690";
import { STEPS } from "./etapes.mjs?v=690";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=690";

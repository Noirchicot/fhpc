...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=629";
import { STEPS } from "./etapes.mjs?v=629";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=629";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=627";
import { STEPS } from "./etapes.mjs?v=627";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=627";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=701";
import { STEPS } from "./etapes.mjs?v=701";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=701";

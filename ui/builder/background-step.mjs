...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=649";
import { STEPS } from "./etapes.mjs?v=649";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=649";

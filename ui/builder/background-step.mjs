...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=840";
import { STEPS } from "./etapes.mjs?v=840";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=840";

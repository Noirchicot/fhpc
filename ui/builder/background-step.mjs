...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=624";
import { STEPS } from "./etapes.mjs?v=624";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=624";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=835";
import { STEPS } from "./etapes.mjs?v=835";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=835";

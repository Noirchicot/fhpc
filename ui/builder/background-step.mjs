...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=825";
import { STEPS } from "./etapes.mjs?v=825";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=825";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=848";
import { STEPS } from "./etapes.mjs?v=848";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=848";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=813";
import { STEPS } from "./etapes.mjs?v=813";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=813";

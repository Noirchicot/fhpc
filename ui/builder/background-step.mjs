...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=637";
import { STEPS } from "./etapes.mjs?v=637";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=637";

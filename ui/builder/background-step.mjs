...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=786";
import { STEPS } from "./etapes.mjs?v=786";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=786";

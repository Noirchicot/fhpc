...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=626";
import { STEPS } from "./etapes.mjs?v=626";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=626";

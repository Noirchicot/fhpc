...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=656";
import { STEPS } from "./etapes.mjs?v=656";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=656";

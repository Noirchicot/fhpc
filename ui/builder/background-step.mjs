...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=785";
import { STEPS } from "./etapes.mjs?v=785";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=785";

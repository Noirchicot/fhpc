...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=688";
import { STEPS } from "./etapes.mjs?v=688";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=688";

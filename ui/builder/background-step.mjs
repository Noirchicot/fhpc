...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=727";
import { STEPS } from "./etapes.mjs?v=727";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=727";

...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=632";
import { STEPS } from "./etapes.mjs?v=632";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=632";

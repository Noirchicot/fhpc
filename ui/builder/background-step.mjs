...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=641";
import { STEPS } from "./etapes.mjs?v=641";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=641";

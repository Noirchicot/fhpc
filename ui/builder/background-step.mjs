...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=728";
import { STEPS } from "./etapes.mjs?v=728";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=728";

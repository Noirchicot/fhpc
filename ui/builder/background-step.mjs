...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=780";
import { STEPS } from "./etapes.mjs?v=780";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=780";

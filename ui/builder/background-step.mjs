...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=769";
import { STEPS } from "./etapes.mjs?v=769";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=769";

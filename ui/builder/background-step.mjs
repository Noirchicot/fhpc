...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=744";
import { STEPS } from "./etapes.mjs?v=744";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=744";

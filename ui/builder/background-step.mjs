...
import { renderBoostGlisse, featInfo } from "./inheritance-step.mjs?v=821";
import { STEPS } from "./etapes.mjs?v=821";
...
import { porteUneDecisionOuverte } from "./parcours.mjs?v=821";

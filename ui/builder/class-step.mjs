...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=266";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=266";
import { renderConfirmDialog } from "./confirm.mjs?v=266";
import { renderChoixGlisses } from "./glisser.mjs?v=266";

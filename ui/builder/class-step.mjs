...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=36";
import { renderFicheBody, renderCardRows, renderCardNames } from "./catalogue.mjs?v=36";
import { renderConfirmDialog } from "./confirm.mjs?v=36";
import { renderChoixGlisses } from "./glisser.mjs?v=36";
...
const DOS_DE_CARTE = "./assets/arcana/back.jpg?v=36";

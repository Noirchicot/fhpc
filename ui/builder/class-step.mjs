...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=640";
import { renderFicheBody, renderBilanLignes, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=640";
...
import { FH_SKILLS_FLAG } from "../../src/modules/fh/skill-pool.mjs?v=640";
import { renderConfirmDialog } from "./confirm.mjs?v=640";
import { renderChoixGlisses } from "./glisser.mjs?v=640";
import { lienSkillFhWeb, lienFeatureFhWeb, lienFeatsFhWeb, lienOptionDeClasseFhWeb, lienSortParNomFhWeb } from "./liens-fh.mjs?v=640";

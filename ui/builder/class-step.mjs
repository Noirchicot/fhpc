...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=34";
import { renderFicheBody, renderCardRows, renderCardNames } from "./catalogue.mjs?v=34";
import { renderConfirmDialog } from "./confirm.mjs?v=34";
import { renderChoixGlisses } from "./glisser.mjs?v=34";
...
const DOS_DE_CARTE = "./assets/arcana/back.jpg?v=34";

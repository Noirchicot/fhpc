...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=705";
...
import { FH_SKILLS_FLAG } from "../../src/modules/fh/skill-pool.mjs?v=705";
import { renderConfirmDialog } from "./confirm.mjs?v=705";
import { renderChoixGlisses } from "./glisser.mjs?v=705";
import { lienSkillFhWeb, lienFeatureFhWeb, lienFeatsFhWeb, lienOptionDeClasseFhWeb, lienSortParNomFhWeb } from "./liens-fh.mjs?v=705";

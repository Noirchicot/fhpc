...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=89";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=89";
import { renderConfirmDialog } from "./confirm.mjs?v=89";
import { renderChoixGlisses } from "./glisser.mjs?v=89";

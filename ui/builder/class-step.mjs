...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=37";
import { renderFicheBody, renderCardRows, renderCardNames } from "./catalogue.mjs?v=37";
import { renderConfirmDialog } from "./confirm.mjs?v=37";
import { renderChoixGlisses } from "./glisser.mjs?v=37";
...
const DOS_DE_CARTE = "./assets/arcana/back.jpg?v=37";

...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=66";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=66";
import { renderConfirmDialog } from "./confirm.mjs?v=66";
import { renderChoixGlisses } from "./glisser.mjs?v=66";

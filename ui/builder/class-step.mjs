...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=106";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=106";
import { renderConfirmDialog } from "./confirm.mjs?v=106";
import { renderChoixGlisses } from "./glisser.mjs?v=106";

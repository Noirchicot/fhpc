...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=101";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=101";
import { renderConfirmDialog } from "./confirm.mjs?v=101";
import { renderChoixGlisses } from "./glisser.mjs?v=101";

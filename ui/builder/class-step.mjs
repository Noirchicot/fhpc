...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=140";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=140";
import { renderConfirmDialog } from "./confirm.mjs?v=140";
import { renderChoixGlisses } from "./glisser.mjs?v=140";

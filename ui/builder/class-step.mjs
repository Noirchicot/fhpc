...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=78";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=78";
import { renderConfirmDialog } from "./confirm.mjs?v=78";
import { renderChoixGlisses } from "./glisser.mjs?v=78";

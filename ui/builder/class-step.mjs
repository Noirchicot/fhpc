...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=318";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=318";
import { renderConfirmDialog } from "./confirm.mjs?v=318";

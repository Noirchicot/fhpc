...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=846";
import { renderFicheBody, renderBilanLignes, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=846";
/* 📍 lot 190 — le blurb de Fate's Hand sur la fiche SRD, « pour le moment » */
import { blurbDeSecours } from "./fiche-secours.mjs?v=846";
...
import { FH_SKILLS_FLAG } from "../../src/modules/fh/skill-pool.mjs?v=846";
import { renderConfirmDialog } from "./confirm.mjs?v=846";
import { renderChoixGlisses } from "./glisser.mjs?v=846";
import { lienSkillFhWeb, lienFeatureFhWeb, lienFeatsFhWeb, lienOptionDeClasseFhWeb, lienSortParNomFhWeb } from "./liens-fh.mjs?v=846";

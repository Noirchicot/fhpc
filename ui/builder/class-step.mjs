...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=98";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=98";
import { renderConfirmDialog } from "./confirm.mjs?v=98";
import { renderChoixGlisses } from "./glisser.mjs?v=98";

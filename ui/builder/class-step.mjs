...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=70";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=70";
import { renderConfirmDialog } from "./confirm.mjs?v=70";
import { renderChoixGlisses } from "./glisser.mjs?v=70";

...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=35";
import { renderFicheBody, renderCardRows, renderCardNames } from "./catalogue.mjs?v=35";
import { renderConfirmDialog } from "./confirm.mjs?v=35";
import { renderChoixGlisses } from "./glisser.mjs?v=35";
...
const DOS_DE_CARTE = "./assets/arcana/back.jpg?v=35";

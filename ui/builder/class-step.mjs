...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=18";
import { renderFicheBody, renderCardRows, renderCardNames } from "./catalogue.mjs?v=18";
import { renderConfirmDialog } from "./confirm.mjs?v=18";
...
/* ⏳ LE BOUCHE-TROU DE L'IMAGE DE FICHE — aucune n'existe encore (cotes
   ...
   `ui/` charge (lot 75). */
const DOS_DE_CARTE = "./assets/arcana/back.jpg?v=18";

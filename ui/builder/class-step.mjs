...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=706";
...
import { FH_SKILLS_FLAG } from "../../src/modules/fh/skill-pool.mjs?v=706";
import { renderConfirmDialog } from "./confirm.mjs?v=706";
import { renderChoixGlisses } from "./glisser.mjs?v=706";
import { lienSkillFhWeb, lienFeatureFhWeb, lienFeatsFhWeb, lienOptionDeClasseFhWeb, lienSortParNomFhWeb } from "./liens-fh.mjs?v=706";

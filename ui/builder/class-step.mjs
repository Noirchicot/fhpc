...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=848";
import { renderFicheBody, renderBilanLignes, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=848";
/* 📍 lot 190 — le blurb de Fate's Hand sur la fiche SRD, « pour le moment » */
import { blurbDeSecours } from "./fiche-secours.mjs?v=848";
...
import { FH_SKILLS_FLAG } from "../../src/modules/fh/skill-pool.mjs?v=848";
import { renderConfirmDialog } from "./confirm.mjs?v=848";
import { renderChoixGlisses } from "./glisser.mjs?v=848";
import { lienSkillFhWeb, lienFeatureFhWeb, lienFeatsFhWeb, lienOptionDeClasseFhWeb, lienSortParNomFhWeb } from "./liens-fh.mjs?v=848";

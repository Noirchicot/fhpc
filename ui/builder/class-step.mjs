...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=333";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=333";
import { renderConfirmDialog } from "./confirm.mjs?v=333";

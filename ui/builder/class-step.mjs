...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=151";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=151";
import { renderConfirmDialog } from "./confirm.mjs?v=151";
import { renderChoixGlisses } from "./glisser.mjs?v=151";

...
import { planAt, planSlots, renderSlotQcm } from "./carnet.mjs?v=96";
import { renderFicheBody, renderCardRows, renderCardNames, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=96";
import { renderConfirmDialog } from "./confirm.mjs?v=96";
import { renderChoixGlisses } from "./glisser.mjs?v=96";

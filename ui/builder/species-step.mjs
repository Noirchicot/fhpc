...
import { planAt, planSlots, renderPicker, decisionRefusalWord } from "./carnet.mjs?v=792";
import { renderFicheBody, renderCardRows, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=792";
/* 📍 lot 190 — le blurb de Fate's Hand sur la fiche SRD, « pour le moment » */
import { blurbDeSecours } from "./fiche-secours.mjs?v=792";
...
import { spellInfo, skillInfo, skillLabel as motDeLaCompetence } from "./class-step.mjs?v=792";
...
import { motDuVerrou } from "./skills-step.mjs?v=792";
import { lienSkillFhWeb, sortEstModifieFh, lienSortFhWeb } from "./liens-fh.mjs?v=792";
import { etapeParId } from "./etapes.mjs?v=792";
import { traitsDeLEspece } from "../../src/modules/fh/traits.mjs?v=792";

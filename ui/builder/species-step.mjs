...
import { planAt, planSlots, renderPicker, decisionRefusalWord } from "./carnet.mjs?v=840";
import { renderFicheBody, renderCardRows, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=840";
/* 📍 lot 190 — le blurb de Fate's Hand sur la fiche SRD, « pour le moment » */
import { blurbDeSecours } from "./fiche-secours.mjs?v=840";
...
import { spellInfo, skillInfo, skillLabel as motDeLaCompetence } from "./class-step.mjs?v=840";
...
import { motDuVerrou } from "./skills-step.mjs?v=840";
import { lienSkillFhWeb, sortEstModifieFh, lienSortFhWeb } from "./liens-fh.mjs?v=840";
import { etapeParId } from "./etapes.mjs?v=840";
import { traitsDeLEspece } from "../../src/modules/fh/traits.mjs?v=840";

...
import { planAt, planSlots, renderPicker, decisionRefusalWord } from "./carnet.mjs?v=653";
import { renderFicheBody, renderCardRows, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=653";
/* 📍 lot 190 — le blurb de Fate's Hand sur la fiche SRD, « pour le moment » */
import { blurbDeSecours } from "./fiche-secours.mjs?v=653";
...
import { spellInfo, skillInfo, skillLabel as motDeLaCompetence } from "./class-step.mjs?v=653";
...
import { motDuVerrou } from "./skills-step.mjs?v=653";
import { lienSkillFhWeb, sortEstModifieFh, lienSortFhWeb } from "./liens-fh.mjs?v=653";
import { etapeParId } from "./etapes.mjs?v=653";
import { traitsDeLEspece } from "../../src/modules/fh/traits.mjs?v=653";

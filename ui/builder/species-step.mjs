...
import { planAt, planSlots, renderPicker, decisionRefusalWord } from "./carnet.mjs?v=743";
import { renderFicheBody, renderCardRows, imageDeFiche, DOS_DE_CARTE } from "./catalogue.mjs?v=743";
/* 📍 lot 190 — le blurb de Fate's Hand sur la fiche SRD, « pour le moment » */
import { blurbDeSecours } from "./fiche-secours.mjs?v=743";
...
import { spellInfo, skillInfo, skillLabel as motDeLaCompetence } from "./class-step.mjs?v=743";
...
import { motDuVerrou } from "./skills-step.mjs?v=743";
import { lienSkillFhWeb, sortEstModifieFh, lienSortFhWeb } from "./liens-fh.mjs?v=743";
import { etapeParId } from "./etapes.mjs?v=743";
import { traitsDeLEspece } from "../../src/modules/fh/traits.mjs?v=743";

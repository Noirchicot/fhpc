...
import * as D from "./x5-disposition.mjs?v=835";
import { pouvoirsDe, coteDe, encorePossibles, basesDe, bonusDe, enPieces, prixSaisi, prixEnPO, PLAFOND_QTE,
  coteDUneVariante, recordDUneVariante, estMunition, LOT_MUNITION } from "./craft.mjs?v=835";
import { DESTINATIONS, montantDeLaBourse, popupDeLaBourse, reglesDeLaBourse } from "./gear-ecran.mjs?v=835";
import { corpsDuJeton } from "./jeton-objet.mjs?v=835";
import { nomCrafte, variantesDe } from "../../src/build/objet-crafte.mjs?v=835";
...
import { construireX5Parchemin, estFicheParchemin } from "./x5-parchemin.mjs?v=835";

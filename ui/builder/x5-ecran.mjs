...
import * as D from "./x5-disposition.mjs?v=825";
import { pouvoirsDe, coteDe, encorePossibles, basesDe, bonusDe, enPieces, prixSaisi, prixEnPO, categorieAffichee, PALIERS, PLAFOND_QTE,
  coteDUneVariante, recordDUneVariante } from "./craft.mjs?v=825";
import { DESTINATIONS, montantDeLaBourse, popupDeLaBourse, reglesDeLaBourse } from "./gear-ecran.mjs?v=825";
import { corpsDuJeton } from "./jeton-objet.mjs?v=825";
import { nomCrafte, variantesDe } from "../../src/build/objet-crafte.mjs?v=825";

...
import * as D from "./x5-disposition.mjs?v=837";
import { pouvoirsDe, coteDe, encorePossibles, basesDe, bonusDe, enPieces, prixSaisi, prixEnPO, PLAFOND_QTE,
  coteDUneVariante, recordDUneVariante, estMunition, LOT_MUNITION } from "./craft.mjs?v=837";
import { DESTINATIONS, montantDeLaBourse, popupDeLaBourse, reglesDeLaBourse } from "./gear-ecran.mjs?v=837";
import { corpsDuJeton } from "./jeton-objet.mjs?v=837";
import { nomCrafte, variantesDe } from "../../src/build/objet-crafte.mjs?v=837";
...
import { construireX5Parchemin, estFicheParchemin } from "./x5-parchemin.mjs?v=837";

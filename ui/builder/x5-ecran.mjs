...
import * as D from "./x5-disposition.mjs?v=828";
import { pouvoirsDe, coteDe, encorePossibles, basesDe, bonusDe, enPieces, prixSaisi, prixEnPO, PLAFOND_QTE,
  coteDUneVariante, recordDUneVariante } from "./craft.mjs?v=828";
import { DESTINATIONS, montantDeLaBourse, popupDeLaBourse, reglesDeLaBourse } from "./gear-ecran.mjs?v=828";
import { corpsDuJeton } from "./jeton-objet.mjs?v=828";
import { nomCrafte, variantesDe } from "../../src/build/objet-crafte.mjs?v=828";
